exec sp_renamedb 'SQL22-1', 'SQL221'

exec sp_renamedb 'SQL 22-1', 'SQL22-1'
create schema BCP;
go
...
-- Выгрузка данных
bcp SQL221.BCP.Title out C:\Storage\bcp\Title_out.txt -c -S 159.224.194.250 -U sa -P rLC9s39J7h
--=======================================================================================BCP===========================================================================
...
select * from [TARGET].[Title];
select * from [TARGET].[Status];
select * from [TARGET].Office;
select * from [TARGET].Employee;
select * from [TARGET].[Email];
select * from [TARGET].[Phone];


select e.*,
       o.*
  from [TARGET].Employee as e 
  inner join [TARGET].Office as o on o.REGION_ID = e.REGION_ID
                              and o.DEP_ID = e.DEP_ID                    
 where e.STATUS_ID = 1
   and e.MANAGER_ID = 1
;
--========================================================================================================================================================================
